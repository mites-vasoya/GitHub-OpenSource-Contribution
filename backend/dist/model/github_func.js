...
exports.GitHubFunc = void 0;
const functions_1 = require("../library/functions");
const octokit_1 = require("../library/octokit");
class GitHubFunc {
    constructor() {
        this.get_rate_limit = () => __awaiter(this, void 0, void 0, function* () {
            const result = yield octokit_1.octokit.request("GET /rate_limit", {
                owner: "github",
                repo: "docs",
                per_page: 2,
            });
